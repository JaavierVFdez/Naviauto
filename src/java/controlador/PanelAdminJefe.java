 ...
 * @author javie
 */
@WebServlet(name = "PanelAdminJefe", urlPatterns = {"/PanelAdminJefe"})
public class PanelAdminJefe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (tipoUsuario.equals("jefe")) {
                ...
                request.getRequestDispatcher("gestion/jefe/paginaInicioJefe.jsp").forward(request, response);
                return;
