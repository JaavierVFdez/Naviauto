    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getAttribute("matriculaExiste") != null) {
                cocheAdded = (boolean)request.getAttribute("matriculaExiste");
            }
            ...
            if(vehiculos == null) {
                    System.out.println("asjidnasidasdhauidhaius");
            } else {
                for(Vehiculo vehiculo : vehiculos) {
                    System.out.println(vehiculo.getMatricula());
                    System.out.println(vehiculo.getDni());
                    System.out.println(vehiculo.getModelo());
                    System.out.println(vehiculo.getMarca());
                    System.out.println(vehiculo.getAnyoVehiculo());
                    System.out.println(vehiculo.getKilometrajeActual());
                }
            }
            ...
            request.getRequestDispatcher("gestion/admin/administrarVehiculos.jsp").forward(request, response);
            return;
        }
    }
