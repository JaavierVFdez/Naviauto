 ...
 * @author javie
 */
@WebServlet(name = "PiezaEditada", urlPatterns = {"/PiezaEditada"})
public class PiezaEditada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println(request.getParameter("codigo_pieza"));
            ...
            if (reparacionDao.codigoReparacionExiste(codigo_reparacion)) {
                ...
                piezaDao.editarPieza(codigo_pieza, codigo_reparacion, nombre, fabricante, precio);
