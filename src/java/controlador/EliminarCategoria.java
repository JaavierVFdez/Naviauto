...
public class EliminarCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Comprobamos si la categoria que queremos eliminar, existe en algun producto
            if (!productoDao.existeCategoria(nombre_categoria)) {
                categoriaDao.eliminarCategoria(nombre_categoria);
