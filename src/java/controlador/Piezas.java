 ...
 * @author javie
 */
@WebServlet(name = "Piezas", urlPatterns = {"/Piezas"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getAttribute("matriculaExiste") != null) {
                reparacionExiste = (boolean)request.getAttribute("reparacionExiste");
            }
            ...
            if (tipoUsuario.equals("jefe") || tipoUsuario.equals("admin")) {
                List<Pieza> piezas = piezaDao.obtenerPiezas();
                request.setAttribute("piezas", piezas);
                request.setAttribute("reparacionExiste", reparacionExiste);
                
                request.getRequestDispatcher("gestion/admin/administrarPiezas.jsp").forward(request, response);
                return;
