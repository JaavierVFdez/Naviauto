<%-- 
    Document   : misReparaciones
    Created on : 8 jun 2023, 5:01:47
    Author     : javie
--%>
...
<html>
    <head>
        ...
        <title>Naviauto - Mis Reparaciones</title>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2></a><b>Mis Reparaciones</b></h2>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover text-center">
                        <c:choose>
                            <c:when test="${empty reparaciones}">
                                    ...
                                    <c:forEach items="${reparaciones}" var="reparacion">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="DetalleReparacion">
                                                    <input type="hidden" name="codigo_reparacion" value="${reparacion.codigo_reparacion}"/>
                                                    <input type="hidden" name="matricula" value="${reparacion.matricula}"/>
                                                    <input type="hidden" name="descripcion" value="${reparacion.descripcion}"/>
                                                    <input type="hidden" name="fechaEntrada" value="${reparacion.fechaEntrada}"/>
