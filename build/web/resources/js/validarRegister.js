...
window.onload = validarRegistro;

function validarRegistro() {
    document.getElementById("crearCuenta").addEventListener('click', validarNombre, false);
    document.getElementById("crearCuenta").addEventListener('click', validarApellido, false);
    document.getElementById("crearCuenta").addEventListener('click', validarTelefono, false);
    document.getElementById("crearCuenta").addEventListener('click', validarDNI, false);
    document.getElementById("crearCuenta").addEventListener('click', validarCorreo, false);
    document.getElementById("crearCuenta").addEventListener('click', validarPassword, false);
}

function validarNombre(e) {
    var pNombre = /^[A-Za-z\s]+$/;
    var nombre = document.getElementById('nombreRegister').value;
    var campo = document.getElementById('nombreRegister');
...
function validarApellido(e) {
    ...
    var apellido = document.getElementById('apellidoRegister').value;
    var campo = document.getElementById('apellidoRegister');
...
function validarTelefono(e) {
    ...
    var telefono = document.getElementById('telefonoRegister').value;
    var campo = document.getElementById('telefonoRegister');
...
function validarDNI(e) {
    var pDNI = /^\d{8}[a-zA-Z]$/;
    var dni = document.getElementById('dniRegister').value;
    var campo = document.getElementById('dniRegister');
...
function validarCorreo(e) {
    ...
    var email = document.getElementById('correoRegister').value;
    var campo = document.getElementById('correoRegister');
...
function validarPassword(e) {
    ...
    var campo = document.getElementById('passwordRegister');
