...
<html>
    ...
    <body>
        ...
        <c:choose>
            <c:when test = "${noeditado}">
                <script>
                    toastr["error"]("DNI, Correo o telefono ya en nuestro sistema.", {"closeButton": false,
                        "debug": false,
                        "newestOnTop": false,
                        "progressBar": false,
        ...
        <div class="container bg-light rounded mt-5 mb-5 w-75 text-center">
            <a href="AdministrarTrabajadores" class="aMenu" style="text-decoration: none;">
            ...
            <form method="post" action="TrabajadorEditado" class="text-center">
                ...
                <textarea autocomplete="off" class="form-control mb-1" style="width: 50%; text-align: center; display: block; margin: 1rem auto;" autocomplete="off" name="direccion" id="direccion" placeholder="Dirección (opcional)" max="256">${usuario.direccion}</textarea><br/><br/>
                ...
                <input type="hidden" name="direccion_actual" value="${usuario.direccion}"/>
                <input type="submit" class="btn btn-danger mb-4" onclick="validarNuevoUsuario()" name="nuevoUsuario" value="Editar Trabajador" id="nuevoUsuario" />
            </form>
        </div>
        <!-- Fin contenido principal -->

        <script src="resources/js/validarNuevoUsuario.js"></script>
    </body>
</html>
