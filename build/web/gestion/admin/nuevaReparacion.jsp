...
<html>
    ...
    <body>
        ...
        <div class="container bg-light rounded mt-5 mb-5 w-75 text-center">
            ...
            <h4 class="mb-5" style="padding-top: 0.8em;"><strong>Nueva Reparación</strong></h4>
            <form method="post" action="AddReparaciones" class="text-center">
                ...
                <textarea autocomplete="off" class="form-control mb-1" style="width: 50%; text-align: center; display: block; margin: 1rem auto;" autocomplete="off" name="descripcion" id="descripcion" placeholder="Descripción de la reparación" autocomplete="off" max="256" required></textarea><br/><br/>
                <label>Fecha Entrada:</label>
                <input class="form-control mb-1" style="width: 37%; text-align: center; display: block; margin: 1rem auto;" autocomplete="off" type="date" name="fechaEntrada" id="fechaEntrada" requireds/><br/><br/>
                <label>Fecha Finalización:</label>
                <input class="form-control mb-1" style="width: 37%; text-align: center; display: block; margin: 1rem auto;" type="date" name="fechaFinalizacion" id="fechaFinalizacion"/><br/><br/>
                <label>Estado</label>
                <select id="estado" name="estado" class="form-control mb-1" style="width: 50%; text-align: center; display: block; margin: 1rem auto; required">
                ...
                <input type="submit" class="btn btn-danger mb-4" onclick="validarNuevaReparacion()" name="nuevaReparacion" value="Añadir Reparación" id="nuevaReparacion" />
            </form>
        </div>
