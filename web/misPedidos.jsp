...
<html>
    <head>
        ...
        <title>Naviauto - Mis pedidos</title>
        <!--Bootstrap-->
                            ...
                            <c:otherwise>
                                ...
                                <tbody>
                                    <c:forEach items="${pedidos}" var="pedido">
                                        <tr>
                                            <td><c:out value="${pedido.id_pedido}" /></td>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="DetallesPedido">
                                                    <input type="hidden" name="id_pedido" value="${pedido.id_pedido}"/>
                                                    <input type="hidden" name="dni" value="${pedido.dni}"/>
                                                    <input type="hidden" name="direccion_envio" value="${pedido.direccion_envio}"/>
                                                    <input type="hidden" name="estado" value="${pedido.estado}"/>
                                                    <input type="hidden" name="precio_total" value="${pedido.precio_total}"/>
