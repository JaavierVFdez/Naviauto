...
<html>
    ...
    <body>
        ...
        <div class="container bg-light rounded mt-5 mb-5 w-75 text-center">
            ...
            <h4 class="mb-5" style="padding-top: 0.8em;"><strong>Nuevo Producto</strong></h4>
            <form method="post" action="AddProducto" class="text-center" enctype="multipart/form-data">
                <label>Imagen:</label>
                <input class="form-control mb-1" placeholder="Introduzca la imagen del producto" type="file" name="url_producto" id="url_producto" autocomplete="off" style="width: 50%; text-align: center; display: block; margin: 1rem auto;"/><br/><br/>
                <label>Nombre <p id="errorNombre" style="display: inline-block; font-style: italic;"></p>:</label>
                <input class="form-control mb-1" placeholder="Introduzca el nombre del producto" type="text" name="nombre" id="nombre" autocomplete="off" style="width: 50%; text-align: center; display: block; margin: 1rem auto;"/><br/><br/>
                <label>Descripción <p id="errorDescripcion" style="display: inline-block; font-style: italic;"></p>:</label><br/>
                <textarea autocomplete="off" class="form-control mb-1" style="width: 50%; text-align: center; display: block; margin: 1rem auto;" autocomplete="off" name="descripcion" id="descripcion" placeholder="Descripción del producto" autocomplete="off" max="256" required></textarea><br/><br/>
                ...
                <select id="categoria" name="categoria" class="form-control mb-1" style="width: 50%; text-align: center; display: block; margin: 1rem auto; required">
                    <c:forEach items="${categorias}" var="categoria">
                        <option value="${categoria.nombre_categoria}" selected>${categoria.nombre_categoria}</option>
                    </c:forEach>
                </select><br/><br/>
                <label>Stock <p id="errorStock" style="display: inline-block; ont-style: italic;"></p>:</label>
                <input type="text" name="stock" id="stock" class="form-control" style="width: 50%; text-align: center; display: block; margin: 1rem auto;" placeholder="1" autocomplete="off"/>
                ...
                <input type="submit" class="btn btn-danger mb-4" onclick="validarNuevoProducto()" name="nuevoProducto" value="Añadir Producto" id="nuevoProducto" />
            </form>
        </div>
