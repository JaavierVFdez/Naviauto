                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h2><a class="aMenu" style="color: white; text-decoration: none; margin-right: 1em;" href="PanelAdminJefe"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-90deg-left" viewBox="0 0 16 16">
                                        ...
                                        </svg></a><b>Administrar Reparaciones</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href="NuevaReparacion" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Añadir Reparación</span></a>						
                            </div>
                        </div>
                    </div>
                    <table id="tabla" class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${reparaciones}" var="reparacion">
                                <tr>
                                    <td><c:out value="${reparacion.codigo_reparacion}" /></td>
                                    <td><c:out value="${reparacion.matricula}"/></td>
                                    <td><c:out value="${reparacion.descripcion}" /></td>
                                    <td><c:out value="${reparacion.fechaEntrada}" /></td>
                                    <td><c:out value="${reparacion.fechaFinalizacion}" /></td>
                                    <td><c:out value="${reparacion.estado}" /></td>
                                    <td><c:out value="${reparacion.precio}" /> €</td>
                                    <td class="d-flex flex-row" style="padding-top: 50%; padding-bottom: 50%;">
                                        <!-- Formulario de edición -->
                                        <form method="post" action="EditarReparacion">
                                            <input type="hidden" name="codigo_reparacion" value="<c:out value="${reparacion.codigo_reparacion}" />" />
                                            <input type="hidden" name="matricula" value="<c:out value="${reparacion.matricula}" />" />
                                            <input type="hidden" name="descripcion" value="<c:out value="${reparacion.descripcion}" />" />
                                            <input type="hidden" name="fechaEntrada" value="<c:out value="${reparacion.fechaEntrada}" />" />
                                            <input type="hidden" name="fechaFinalizacion" value="<c:out value="${reparacion.fechaFinalizacion}" />" />
                                            <input type="hidden" name="estado" value="<c:out value="${reparacion.estado}" />" />
                                            <input type="hidden" name="precio" value="<c:out value="${reparacion.precio}" />" />
                                        ...
                                        <form method="post" action="EliminarReparacion">
                                            <input type="hidden" name="codigo_reparacion" value="<c:out value="${reparacion.codigo_reparacion}" />" />
                                            <input type="hidden" name="matricula" value="<c:out value="${reparacion.matricula}" />" />
                                            <input type="hidden" name="descripcion" value="<c:out value="${reparacion.descripcion}" />" />
                                            <input type="hidden" name="fechaEntrada" value="<c:out value="${reparacion.fechaEntrada}" />" />
                                            ...
                                            <input type="hidden" name="estado" value="<c:out value="${reparacion.estado}" />" />
                                            <input type="hidden" name="precio" value="<c:out value="${reparacion.precio}" />" />
                                            <button type="submit" style="background-color: transparent; border:  0px solid black;"><svg style="color: red" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
